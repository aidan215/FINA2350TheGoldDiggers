...
vol_col = "Future_Realized_Volatility_weekly"
...
for model in models:
    results[model] = results[model].merge(y[["Date", "Future_Realized_Volatility_weekly", "bucket"]], on="Date", how="left")
    ...
    results[model]["mse"] = mean_squared_error(results[model]["Volatility_Market_Adjusted"], results[model]['Future_Realized_Volatility_weekly'])
    
    results[model]["mae"] = mean_absolute_error(results[model]["Volatility_Market_Adjusted"], results[model]['Future_Realized_Volatility_weekly'])
...
out_path = "results/classification_output_weekly.txt"
